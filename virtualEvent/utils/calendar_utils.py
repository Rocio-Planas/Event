...
def generate_ics(event):
    """
    Recibe un objeto VirtualEvent y devuelve el contenido del archivo .ics como string.
    """
    cal = Calendar()
    cal.add("prodid", "-//EventPulse//Event Calendar//ES")
    cal.add("version", "2.0")
    ...
    ics_event.add("location", "Evento Virtual")
