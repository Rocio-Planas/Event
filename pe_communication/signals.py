...
def notification_on_subscription_created(sender, instance, created, **kwargs):
    """
...
def notification_on_subscription_deleted(sender, instance, **kwargs):
    """
...
def notification_on_activity_changed(sender, instance, **kwargs):
    """
    ...
    if notifications_to_create:
        ...
        logger.info(f'Notificaciones de cambio de agenda enviadas a {len(notifications_to_create)} usuarios')