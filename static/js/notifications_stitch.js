/**
 * Notifications functionality for EventPulse (Stitch theme)
...
(function () {
    ...
    // Toggle notification dropdown (Stitch theme specific)
    window.toggleNotificationDropdown = function (event) {
        event.stopPropagation();
        var menu = document.getElementById("notification-dropdown-menu");
        if (menu) {
    ...
    function renderNotifications(notifications) {
        ...
        container.innerHTML = notifications
            .map(function (n) {
                ...
                return (
                    '<a class="dropdown-item notification-item block px-3 py-2 hover:bg-surface-container-high' +
                    (n.is_read ? "" : " bg-light") +
                    '" href="#" data-id="' +
                    n.id +
                    '" onclick="markAsRead(' +
